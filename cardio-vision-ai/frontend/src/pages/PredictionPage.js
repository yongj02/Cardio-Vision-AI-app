...
import { Button, Collapse, Alert, Spinner, ProgressBar, Table, Modal, DropdownButton, Dropdown, Card } from 'react-bootstrap';
            ...
            <div className="row justify-content-center">
                <div className="col-md-12">
                    <Card>
                        ...
                        <Card.Header as="h2">Make Predictions</Card.Header>
